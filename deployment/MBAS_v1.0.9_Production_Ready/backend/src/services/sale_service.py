...
class SaleService:
    ...
    def create_sale(session: Session, sale_in: SaleCreate, user_id: int) -> Sale:
        ...
        for item_in in sale_in.items:
            ...
            # Calculate subtotal (convert floats to Decimal for accurate calculations)
            ...
            sale_item = SaleItem(
                ...
                cost_price=cost_price,  # CRITICAL: Snapshot cost_price at time of sale
                subtotal=subtotal
            )
            sale_items.append(sale_item)

        # 3. Final calculations (ensure discount is Decimal)
