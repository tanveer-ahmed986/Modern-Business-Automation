...
from src.core.db import init_db, cleanup_connections
...
async def health_check():
    """Enhanced health check endpoint for monitoring and auto-recovery."""
    try:
