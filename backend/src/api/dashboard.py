...
from backend.src.models.sales import Sale, SaleItem, SaleStatus
from backend.src.models.inventory import Product, Category
from backend.src.models.sales import Customer
